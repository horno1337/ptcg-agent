"""Run the locked Dobi-v1 Munkidori-control PPO experiment."""
...
from tools.research import dobi_v1_munkidori_control_reward as REWARD  # noqa: E402
...
def _install_contract() -> None:
    ...
    base.LOCK = LOCK
    base.POP = POP
    base.RESULT_SCHEMA = "ptcg.dobi-v1.munkidori-control-ppo-v1-training-result.v1"
    ...
    base.ROLLOUT_POTENTIAL = REWARD.potential
    base.TRAJECTORY_FINALIZER = REWARD.finish_trajectory
    base.REWARD_CONTRACT = "potential"
    base.TERMINAL_DIRECTORY = "terminal-update-130-candidate"
